...
| Loot item                       | Count matching items generated by a mob, fishing, or a player-broken block.                |
...
Minecraft has no advancement trigger for tying an exact generated item to the entity that dropped it.
Use `polyquest:loot_item` for that case:
